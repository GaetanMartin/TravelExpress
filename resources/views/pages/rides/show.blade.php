...
@section('content')
	...
	<div class="well">
		...
		<div class="container">
			...
			@else
				<div class="btn-group">
					<a href="{{ route('bookings.create', ['id' => $ride->id]) }}" class="btn btn-info {{ $nbSeatsAvailable > 0 ? '':'disabled' }}" role="button"><i class="fa fa-shopping-cart" aria-hidden="true"></i> @lang('messages.book')</a>
				</div>
			@endif
			</div>
		</div>
